...
@app.get("/")
async def root():
    return { 'Spanish tutorial' : ''' Hola! Este es un proyecto individual para la carrera de Data Science de Henry.
...
2-Para la función de predicción es necesario completar con "genre", "early_access", "metascore" y "year".
-Para genre se debe ingresar un valor de la siguiente lista:
...
"[1983, 1984, 1985, 1986, 1987, 1988, 1989, 1990, 1991, 1992, 1993, 1994, 1995, 1996, 1997, 1998, 1999, 2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2021]" '''}, {'English tutorial' : '''Hello! This is an individual project for Henry's Data Science career.
This is a small instructive for the correct operation of the API.
1-For the functions where you are asked to enter a year, you must enter one of those that appear in the following list, since they are the years that are in the database, otherwise the function will indicate that there is an error .
"[1983, 1984, 1985, 1986, 1987, 1988, 1989, 1990, 1991, 1992, 1993, 1994, 1995, 1996, 1997, 1998, 1999, 2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2021]"
2-For the prediction function it is necessary to complete with "genre", "early_access", "metascore" and "year".
-For genre you must enter a value from the following list:
" ['Action', 'Adventure', 'Animation &amp; Modeling', 'Audio Production', 'Casual', 'Design & Illustration', 'Early Access', 'Education', 'Free to Play', 'Indie ', 'Massively Multiplayer', 'Photo Editing', 'RPG', 'Racing', 'Simulation', 'Software Training', 'Sports', 'Strategy', 'Utilities', 'Video Production', 'Web Publishing' ] "
-For early_access "true" or "false" must be entered, since it is a boolean value.
-For metascore you must enter a number from "1" to "100", following that format.
-For year, the indications of the functions of point 1 are repeated. You must enter one of those that appear in the following list:
"[1983, 1984, 1985, 1986, 1987, 1988, 1989, 1990, 1991, 1992, 1993, 1994, 1995, 1996, 1997, 1998, 1999, 2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2021]" '''}
